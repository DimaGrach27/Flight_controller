...
public:
    ...
    const std::string HEADER_LOG_FLIGHT_SAMPLE = "time_ms,imu_seq,dt,imu_dt,rc_thr,rc_roll,rc_pitch,rc_yaw,t_roll,t_pitch,t_yaw,g_roll,g_pitch,g_yaw,est_roll,est_pitch,c_roll,c_pitch,c_yaw,m1,m2,m3,m4";
