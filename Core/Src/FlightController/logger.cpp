...
void Logger::SendFlightLogCsv()
{
    ...
    sendNamed("t_roll", m_logSample.targetRollRateRadSec);
    sendNamed("t_pitch", m_logSample.targetPitchRateRadSec);
    sendNamed("t_yaw", m_logSample.targetYawRateRadSec);
    sendNamed("g_roll", m_logSample.gyroRollRadSec);
    ...
    sendNamed("est_roll", m_logSample.estimatedRollRad);
    sendNamed("est_pitch", m_logSample.estimatedPitchRad);
    sendNamed("est_yaw", m_logSample.estimatedYawRad);
    sendNamed("gyr_b_x", m_logSample.gyroBiasX);
